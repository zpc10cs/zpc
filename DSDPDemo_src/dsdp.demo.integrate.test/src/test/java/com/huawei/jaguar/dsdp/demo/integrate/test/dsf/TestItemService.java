package com.huawei.jaguar.dsdp.demo.integrate.test.dsf;
...
import com.huawei.jaguar.dsdp.demo.integrate.test.BaseIntegrateTestCase;
...
public class TestItemService extends BaseIntegrateTestCase
{
    private ItemService itemService = (ItemService) applicationContext.getBean("dsf.dsdpdemo.itemService");
